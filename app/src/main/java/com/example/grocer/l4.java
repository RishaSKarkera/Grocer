    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(l4.this,home.class);
                startActivity(i);
                finish();
            }
        });
        a1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st1.equals("")) {
                    ...
                    tot = tot + (qty1 * 250);
                    str=str+"--> Cut Roses("+String.valueOf(qty1)+" kg)\n";
                }
                else{
                    disp();
                }
        ...
        a2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st2.equals("")) {
                    ...
                    tot = tot + (qty2 * 103);
                    str=str+"--> Marigold-Orange("+String.valueOf(qty2)+" kg)\n";
                }
                else{
                    disp();
                }
        ...
        a3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st3.equals("")) {
                    ...
                    tot = tot + (qty3 * 149);
                    str=str+"--> Marigold-Yellow("+String.valueOf(qty3)+" kg)\n";
                }
                else{
                    disp();
                }
        ...
        a4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st4.equals("")) {
                    ...
                    tot = (float) (tot + (qty4 * 8.2));
                    str=str+"--> Banaana Leaf("+String.valueOf(qty4)+" pcs)\n";
                }
                else{
                    disp1();
                }
                ...
                String st6=m.getText().toString();
                    ...
                    if (tot != 0) {
                        if(!st6.equals("")) {
                            ...
                            Intent i = new Intent(l4.this, lastorder.class);
                            startActivity(i);
                            finish();
                        }
                        else
                        ...
                        Intent i = new Intent(l4.this, last.class);
                        startActivity(i);
                        finish();
                    }
                }
