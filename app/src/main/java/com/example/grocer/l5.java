    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(l5.this,home.class);
                startActivity(i);
                finish();
            }
        });
        a1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st1.equals("")) {
                    ...
                    tot = tot + (qty1 * 392);
                    str=str+"--> Garlic("+String.valueOf(qty1)+" Kg)\n";
                }
                else{
                    disp();
                }
        ...
        a2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st2.equals("")) {
                    ...
                    tot = tot + (qty2 * 99);
                    str=str+"-->Basil-Italian("+String.valueOf(qty2)+" Kg)\n";
                }
                else{
                    disp();
                }
        ...
        a3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st3.equals("")) {
                    ...
                    tot = tot + (qty3 * 60);
                    str=str+"--> Lemon("+String.valueOf(qty3)+" Kg)\n";
                }
                else{
                    disp();
                }
        ...
        a4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st4.equals("")) {
                    ...
                    tot = tot + (qty4 * 250);
                    str=str+"-->Corriander Leaves("+String.valueOf(qty4)+" Kg)\n";
                }
                else{
                    disp();
                }
        ...
        c.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String st6=m.getText().toString();
                    ...
                    if (tot != 0) {
                        if(!st6.equals("")) {
                            Intent i = new Intent(l5.this, lastorder.class);
                            startActivity(i);
                            finish();
                        }
                        else
                        ...
                        Intent i = new Intent(l5.this, last.class);
                        startActivity(i);
                        finish();
                    }
                }
