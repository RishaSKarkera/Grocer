...
public class l1 extends AppCompatActivity {
    ...
    b.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent i=new Intent(l1.this,home.class);
            startActivity(i);
            finish();
        }
    });
    a1.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if(!st1.equals("")) {
                ...
                tot = tot + (qty1 * 50);
                str=str+"--> Capsicum-green("+String.valueOf(qty1)+" Kg)\n";
            }
            else{
                disp();
            }
        ...
        a2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st2.equals("")) {
                    ...
                    tot = tot + (qty2 * 36);
                    str=str+"-->Cucumber("+String.valueOf(qty2)+" Kg)\n";
                }
                else{
                    disp();
                }
        ...
        a3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st3.equals("")) {
                    ...
                    tot = tot + (qty3 * 92);
                    str=str+"--> Carrot-Ooty("+String.valueOf(qty3)+" Kg)\n";
                }
                else{
                    disp();
                }
        ...
        a4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!st4.equals("")) {
                    ...
                    tot = tot + (qty4 * 125);
                    str=str+"-->Onion("+String.valueOf(qty4)+" Kg)\n";
                }
                else{
                    disp();
                }
                ...
                String st6=m.getText().toString();
                    ...
                    if (tot != 0) {
                        if(!st6.equals("")) {
                            ...
                            Intent i = new Intent(l1.this, lastorder.class);
                            startActivity(i);
                            finish();
                        }
                        else
                        ...
                        Intent i = new Intent(l1.this, last.class);
                        startActivity(i);
                        finish();
                    }
                }
